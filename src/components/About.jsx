...
const About = () => {
  ...
  return (
    <div className='' style={{padding: '20px'}}>
        <h3 className='font-semibold text-lg pl-5 mb-[-10] md:mb-[-40]' >About Us</h3>
    ...
    <div className=' text-center sm:text-center md:text-left sm:w-fit md:w-1/2 max-w-md mx-auto md:mx-0'>
        <h2 className='text-xl md:text-2xl font-bold text-[rgb(166,139,51)] font-georgia w-fit sm:w-fit md:w-[600px] mb-5 md:w-[100px]'>Our Experienced Attorneys Combine Legal Expertise with Personalized Service</h2>
