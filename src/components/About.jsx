...
const About = () => {
  ...
  return (
    ...
    <div className=' text-center sm:text-center md:text-left sm:w-fit md:w-1/2 max-w-md mx-auto md:mx-0'>
        <h2 className='text-sm sm:text-lg md:text-2xl font-bold text-[rgb(166,139,51)] font-georgia w-fit sm:w-fit md:w-[400pxpx] mb-5 '>Our Experienced Attorneys Combine Legal Expertise with Personalized Service</h2>
