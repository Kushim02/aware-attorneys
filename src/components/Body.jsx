  ...
  return (
    <div className='pt-16 flex flex-col md:flex-row justify-between items-center p-4'>
      <div className='body text-center md:text-left mb-5 max-w-md'>
        <h2 className='text-lg sm:text-xl md:text-2xl font-bold mb-5 mt-10 md:mt-none'> Trusted legal solutions for the real world.</h2>
        <p className='mb-3 p-2  sm:p-0 text-xs sm:text-sm'>We specialise in corporate, commercial, intellectual property law and dispute resolution</p>
        <div className='flex flex-col  sm:flex-row sm:justify-space-between items-center mt-2 '>
            <button className='request w-40 p-2 sm:mb-0 sm:text-sm md:text-base sm:w-auto text-xs'><a href='mailto:izangkushim1@gmail.com'>Request Consultation</a></button>
